...
//	[10, 15, 10, 0, 16, 16, 16, 16, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
	[10, 42, 2, 1, 8, 24, 32, 32, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
	//支援機2(Spear)
	[36, 35, 2, 1, 8, 24, 48, 48, "friend_straight", 21, 7, 15, 15, 7, 1, 0],
	//支援機3(Boom)
	[37, 36,  1, 1, 8, 8, 16, 16, "friend_boom", 21, 7, 15, 15, 7, 1, 0],
	//支援機4(axe)
	[38, 40, 3, 1, 16, 8, 24, 24, "friend_rotate_full", 21, 7, 15, 15, 7, 1, 0],
	//支援機5(wand)
//	[39, 38, 10, 0, 8, 8, 16, 16, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
	[39, 41, 1, 1, 8, 16, 24, 24, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
...
//武器動作(敵用)
	//(sword)
	[41, 42, 2, 3, 8, 24, 16, 16, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
	//(axe)
	[42, 40, 2, 3, 16, 8, 16, 16, "friend_rotate_full", 21, 7, 15, 15, 7, 1, 0],
	//(Boom)
	[43, 36, 1, 3, 8, 8, 16, 16, "friend_boom", 21, 7, 15, 15, 7, 1, 0],
	//(spear)
	[44, 35, 3, 3, 8, 24, 16, 16, "friend_straight", 21, 7, 15, 15, 7, 1, 0],
	//(wand)
	[45, 41, 1, 3, 8, 16, 16, 16, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
