...
//自機
	[ 0, 1, 10, PLAYER	, 16, 16,  32,  32, 0, 0,24,15,15,24, 0, 0],

//自弾
	[6, 26,  8, BULLET_P, 16, 16, 16, 16, "common_vset8", 13, 5, 5, 5, 5, 0, 0],
//誘爆用ダメージ（敵機のダメージ用）
	[11, 7,  8, BULLET_P, 16, 16, 32, 32, 18, 18, 5, 5, 5, 5, 0, 0],

//武器動作(Player用)
    //支援機(sword)
//	[10, 15, 10, 0, 16, 16, 16, 16, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
	[10, 42, 2, BULLET_P, 8, 24, 32, 32, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
	//支援機2(Spear)
	[36, 35, 2, BULLET_P, 8, 24, 48, 48, "friend_straight", 21, 7, 15, 15, 7, 1, 0],
	//支援機3(Boom)
	[37, 36, 1, BULLET_P, 8, 8, 16, 16, "friend_boom", 21, 7, 15, 15, 7, 1, 0],
	//支援機4(axe)
	[38, 40, 3, BULLET_P, 16, 8, 24, 24, "friend_rotate_full", 21, 7, 15, 15, 7, 1, 0],
	//支援機5(wand)
//	[39, 38, 10, 0, 8, 8, 16, 16, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
	[39, 41, 1, BULLET_P, 8, 16, 24, 24, "friend_rotate", 21, 7, 15, 15, 7, 1, 0],
