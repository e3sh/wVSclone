...
//　2024/04/04 削除)scenario1　予備シナリオ　/　未使用　Javascript版では処理方法が変更されている為
//　2024/04/04 削除)scenario2　衝突	　　/　未使用　Javascript版では処理方法が変更されている為
//　2024/04/04 削除)scenario3　X軸枠外　/　未使用　Javascript版では処理方法が変更されている為
//　2024/04/04 削除)scenario4　Y軸枠外　/　未使用　Javascript版では処理方法が変更されている為
//　2024/04/04 削除)scenario5　終了処理　/　未使用　Javascript版では処理方法が変更されている為
//　2024/04/04 削除)ここでは指定しない)id 　 オブジェクトに個別IDを使用する場合に指定する。(アイテムの種類/ID等)2023/1/17時点で未使用
//　score　倒したときのスコア
//　フレームカウントは約60で1秒進む予定
//
function character(){
...
//自機
	[ 0, 1, 10, PLAYER	, 16, 16, 24, 16, 0, 0],//自機
