...
//敵
    //通常
	[ 1, 4,  8,	ENEMY	, 16, 16,  24,  16, 0, 0, 7, 5, 5, 7, 0, 10],
    //Boss_?
	[14, 4, 90, ENEMY	, 16, 16, 24, 24, 0, 0, 35, 5, 5, 35, 0, 50],
    //全方位弾ボス
    [30, 7,  1, BULLET_E, 8, 8, 6, 6, 33, 33, 5, 5, 5, 5, 0, 0],
	//timeover
	[33,31, 240, ENEMY	, 16, 16, 24, 24, 0, 0, 35, 5, 5, 35, 0, 10],
	//enemy boss x
    [34, 4, 120, ENEMY	, 16, 16, 32, 32, 0, 0, 7, 5, 5, 7, 0, 30],
...
//アイテム
	...
	//Weapon
	[15, 38, 1, ITEM, 12, 12, 24, 24, 30, 30, 5, 5, 5, 5, 0, 0], //wand
	[16, 15, 1, ITEM, 12, 12, 24, 24, 30, 30, 5, 5, 5, 5, 0, 0], //sword
	[17, 37, 1, ITEM, 12, 12, 24, 24, 30, 30, 5, 5, 5, 5, 0, 0], //axe
	[18, 16, 1, ITEM, 12, 12, 24, 24, 30, 30, 5, 5, 5, 5, 0, 0], //spear
	[19, 17, 1, ITEM, 12, 12, 24, 24, 30, 30, 5, 5, 5, 5, 0, 0], //boom
	//Ball
	[20, 26, 1, ITEM, 8, 8, 16, 16, 30, 30, 5, 5, 5, 5, 0, 4],
	//1upItem
...
//	[40, 39, 1, ENEMY, 16, 16, 32, 32, 30, 30, 5, 5, 5, 5, 0, 100],
	[40, 39, 1, ENEMY, 12, 12, 24, 24, 30, 30, 5, 5, 5, 5, 0, 100],
	...
	[50, 18, 1, ITEM, 12, 12, 24, 24, 30, 30, 5, 5, 5, 5, 0, 0],//item bow
